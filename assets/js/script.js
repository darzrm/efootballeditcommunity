...
// --- 2. NAVIGASI HALAMAN (SINGLE LOGIC) ---
        ...
        link.onclick = function() {
            ...
            pages.forEach(p => {
                if (p.dataset.page === target) {
                    ...
                    p.style.display = "block"; // Paksa muncul
                } else {
    ...
    if (!session) {
        container.innerHTML = `
            <div style="text-align:center; padding:40px;">
                <p style="color:var(--light-gray); margin-bottom:20px;">Silakan Login</p>
...
window.loadComments = async (blogId) => {
    ...
    if (comments) {
        comments.forEach(comment => {
            ...
            card.innerHTML = `
                <div class="comment-header" style="display: flex; align-items: center; gap: 8px; margin-bottom: 5px;">
                ...
                <div class="comment-footer" style="display: flex; justify-content: flex-end; align-items: center; gap: 8px; margin-top: 8px; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 5px;">
